...
public class Order {
	...
	public void enterFirstName() throws InterruptedException {
		driver.findElement(By.id("inputFirstName")).sendKeys("Chethan");
	}
	...
	public void enterLastName() throws InterruptedException {
		driver.findElement(By.xpath("(//input[@id='inputFirstName'])[2]")).sendKeys("Chethu");
	}
	...
	public void enterEmailId() throws InterruptedException {
		driver.findElement(By.id("inputEmail")).sendKeys("chethan@gmail.com");
	}
	...
	public void enterPassword() throws InterruptedException {
		driver.findElement(By.id("inputPassword")).sendKeys("4567");
	}
	...
	public void enterNumber() throws InterruptedException {
		driver.findElement(By.xpath("(//input[@type='number'])[1]")).sendKeys("9988776655");
	}
	...
	public void enterAddress1() throws InterruptedException {
		driver.findElement(By.id(" address1")).sendKeys("Jain Collage");
	}
	...
	public void enterZIP() throws InterruptedException {
		driver.findElement(By.id("inputZip")).sendKeys("562117");
	}
